...
import SpatialNavigation from 'video.js/src/js/spatial-navigation.js';
import Tech from 'video.js/src/js/tech/tech.js';
import type { TimeRange } from 'video.js/src/js/utils/time.js';
import MediaError from 'video.js/src/js/media-error.js';
import type HtmlTrackElement from 'video.js/src/js/tracks/html-track-element.js';
import ModalDialog from 'video.js/src/js/modal-dialog.js';
import type VideoTrackList from 'video.js/src/js/tracks/video-track-list.js';
import type AudioTrackList from 'video.js/src/js/tracks/audio-track-list.js';
import type TextTrackList from 'video.js/src/js/tracks/text-track-list.js';
import type HtmlTrackElementList from 'video.js/src/js/tracks/html-track-element-list.js';
